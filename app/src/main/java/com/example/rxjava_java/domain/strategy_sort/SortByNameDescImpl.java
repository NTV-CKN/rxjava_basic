...
public class SortByNameDescImpl implements ISortStrategy {
    @Override
    public void sortListUser(List<User> users) {
        users.sort((o1, o2) -> Utils.splitGetName(o2.getFullName()).compareTo(Utils.splitGetName(o1.getFullName())));
    }
}
